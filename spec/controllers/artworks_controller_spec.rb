  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artwork as @artwork" do
        ...
        post :create, {:artwork => { "title" => "invalid value" }}, valid_session
        assigns(:artwork).should be_a_new(Artwork)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested artwork" do
        ...
        Artwork.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => artwork.to_param, :artwork => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the artwork as @artwork" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Artwork.any_instance.stub(:save).and_return(false)
        put :update, {:id => artwork.to_param, :artwork => { "title" => "invalid value" }}, valid_session
        assigns(:artwork).should eq(artwork)
      end
